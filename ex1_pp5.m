...
for i in [1..#Hecke_constituents] do
    ...
    t0 := Realtime();
    unelim_ps, eliminated_g, first_q_for_g := Eliminate_g(g, "ppr", 5, 7, 1, 3 : tw_coprime_to_r := 1, val_tw_above_r := 1, first_q := 11, forbidden_qs := {2, 3, 5, 7}, maximal_duration := 900);
